function [velocityMap, opt] = plotSingleVectorMapOnImage(velocityMap,position_t,position_x,position_y, opt, k, scale)
...
%     cMapSpacingV = (maxGlobalVel-minGlobalVel)/length(fullcolormap);
    ...
    if strcmp(opt.timerDisplay,'UR')
        text(0.85,0.95,[num2str(alltimes(k)*opt.timeFrame,'%1.1f') '    s'],...
        'FontSize',16,...
        'BackgroundColor',[0 0 0],...
        'Units','normalized',...
        'Color',[1 1 1]);
    elseif strcmp(opt.timerDisplay,'UL')
        text(0.05,0.95,[num2str(alltimes(k)*opt.timeFrame,'%1.1f') '    s'],...
        'FontSize',16,...
        'BackgroundColor',[0 0 0],...
        'Units','normalized',...
        'Color',[1 1 1]);
    ...
    elseif strcmp(opt.timerDisplay,'LL')
        text(0.05,0.05,[num2str(alltimes(k)*opt.timeFrame,'%1.1f') '    s'],...
        'FontSize',16,...
        'BackgroundColor',[0 0 0],...
        'Units','normalized',...
        'Color',[1 1 1]);
    elseif strcmp(opt.timerDisplay,'LR')
        text(0.85,0.05,[num2str(alltimes(k)*opt.timeFrame,'%1.1f') '    s'],...
        'FontSize',16,...
        'BackgroundColor',[0 0 0],...
        'Units','normalized',...
        'Color',[1 1 1]);
